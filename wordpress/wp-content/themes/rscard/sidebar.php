        ...
        <div class="widget-area">
            <aside class="widget widget-profile">
                <div class="profile-photo">
                    <img src="<?php echo $info['image'];?>" alt="Robert Smith"/>
                </div>
                <div class="profile-info">
                    <h2 class="profile-title"><?php echo $info['name'];?></h2>
                    <h3 class="profile-position"><?php echo $info['work'];?></h3>
                </div>
            ...
            <aside class="widget widget-popuplar-posts">
                ...
                <ul>
                    <li>
                        <div class="post-media"><a href="index.html"><img src="<?php bloginfo('template_directory');?>/img/uploads/thumb-78x56-1.jpg" alt=""/></a></div>
                        <h3 class="post-title"><a href="index.html">Standard Post Format With Featured Image</a></h3>
                        <div class="post-info"><a href="index.html"><i class="rsicon rsicon-comments"></i>56 comments</a></div>
                    </li>
                    <li>
                        <div class="post-media"><a href="index.html"><img src="<?php bloginfo('template_directory');?>/img/uploads/thumb-78x56-2.jpg" alt=""/></a></div>
                        <h3 class="post-title"><a href="index.html">Standard Post Format With Featured Image</a></h3>
                        <div class="post-info"><a href="index.html"><i class="rsicon rsicon-comments"></i>56 comments</a></div>
                    </li>
                    <li>
                        <div class="post-media"><a href="index.html"><img src="<?php bloginfo('template_directory');?>/img/uploads/thumb-78x56-3.jpg" alt=""/></a></div>
                        <h3 class="post-title"><a href="index.html">Standard Post Format With Featured Image</a></h3>
                        <div class="post-info"><a href="index.html"><i class="rsicon rsicon-comments"></i>56 comments</a></div>
                    </li>
                </ul>
